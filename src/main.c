...
int main(int argc, const char * argv[])
{
    ...
    uint8_t dictionary0[] = {
        ...
        0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00, 0x3a, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload0, sizeof(payload0), 56);
    printf("______\n");
    ...
    uint8_t dictionary1[] = {
        ...
        0xff, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x1a,
        0x00, 0x00, 0x00, 0x5c, 0x00, 0x00, 0x00, 0x3a, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    
    uint8_t compressed1[] = {
        0x06, 0x9b, 0x01, 0x7a, 0x5f, 0x00, 0xf0, 0xc7, 0x01, 0x88, 0x81, 0x04, 0x20, 0x02, 0x0d, 0xb8,
        0x85, 0xa8, 0xc9, 0x08, 0xfa, 0xce, 0x04, 0x0e, 0x00, 0x14, 0x09, 0xff, 0xa4, 0xda, 0x83, 0x06,
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload1, sizeof(payload1), 56);
    printf("______\n");
    ...
    uint8_t dictionary2[] = {
        ...
        0x00, 0x00, 0x00, 0x32, 0x00, 0x00, 0x00, 0x3a, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    
    uint8_t compressed2[] = {
        0x0c, 0x9b, 0x02, 0x58, 0x7d, 0x01, 0x80, 0x00, 0xf1, 0x05, 0x12, 0x00, 0x80, 0xb6, 0xf4, 0x08,
        0x06, 0x14, 0x00, 0x80, 0xf1, 0x00, 0xfe, 0x80, 0x87, 0xa8, 0xdd };
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload2, sizeof(payload2), 56);
    printf("______\n");
    ...
    uint8_t dictionary3[] = {
        ...
        0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0x1c, 0xda, 0xff, 0xfe, 0x00, 0x30, 0x23,
        0x00, 0x00, 0x00, 0x30, 0x00, 0x00, 0x00, 0x3a, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    
    uint8_t compressed3[] = {
        0x04, 0x87, 0x00, 0xa7, 0x68, 0x82, 0xb4, 0xf0, 0x04, 0x01, 0x01, 0x3b, 0xd3, 0x82, 0x02, 0x1f,
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload3, sizeof(payload3), 56);
    printf("______\n");
    ...
    uint8_t compressed4[] = {
        0x05, 0x88, 0x00, 0x26, 0x6c, 0xc0, 0x81, 0xb6, 0xf0, 0x04, 0x02, 0x01, 0xfa, 0xce, 0x82, 0x02,
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload4, sizeof(payload4), 56);
    printf("______\n");
    ...
    uint8_t dictionary5[] = {
        ...
        0x00, 0x00, 0x00, 0x18, 0x00, 0x00, 0x00, 0x3a, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    
    uint8_t compressed5[] = {
        0x04, 0x85, 0x00, 0x90, 0x65, 0xde, 0x02, 0x02, 0xac, 0xa6, 0xeb, 0x84 };
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload5, sizeof(payload5), 56);
    printf("______\n");
    ...
    uint8_t dictionary6[] = {
        ...
        0xfe, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xae, 0xde, 0x48, 0x00, 0x00, 0x00, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x60, 0x00, 0x00, 0x00, 0x3a, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    ...
    uint8_t compressed6[] = {
        ...
        0xf0, 0x02, 0x21, 0x03, 0xa9, 0xe6, 0xb3, 0xcd, 0xaf, 0xa1, 0xdb };
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload6, sizeof(payload6), 56);
    printf("______\n");
    ...
    uint8_t dictionary7[] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x2a, 0x00, 0x00, 0x00, 0x00, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload7, sizeof(payload7), 56);
    printf("______\n");
    ...
    uint8_t dictionary8[] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x23, 0x00, 0x00, 0x00, 0x00, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload8, sizeof(payload8), 56);
    printf("______\n");
    ...
    uint8_t dictionary9[] = {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x43, 0x00, 0x00, 0x00, 0x00, 0x16, 0xfe, 0xfd, 0x17, 0xfe, 0xfd, 0x00, 0x01,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00 };
    ...
    printf("Decompress: ");
    compareBuffer(buffer2, payload9, sizeof(payload9), 56);
    printf("______\n");
